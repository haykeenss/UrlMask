...
echo -e "\e[1;31;42m######│▘ ▘▝▀▘▀▀ ▘ ▘▘  ▘ ▘▀▘▀▀ ▘ ▘│##### \e[0m"
echo -e "\e[1;31;42m######└──────────────────────────┘##### \e[0m \n"
echo -e "\e[40;38;5;82m Please Visit \e[30;48;5;82m https://haytechacademy.rf.gd \e[0m"
echo -e "\e[30;48;5;82m    Copyright \e[40;38;5;82m   HayTechAcaDemy \e[0m \n\n"
...
echo -e "\nGenerating urlmask Link...\n"
final=$mask@$shorter
echo -e "Here is the urlmask URL:\e[32m ${final} \e[0m\n"
exit
fi
if [[ "$words" =~ " " ]]; then
